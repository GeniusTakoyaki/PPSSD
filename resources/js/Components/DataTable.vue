<template>
  <div class="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-6 lg:p-10">
    <div class="mx-auto max-w-7xl">
      ...
      <div v-if="filteredItems.length > 0" class="px-2 py-1 text-xs text-gray-500">
        <a 
          href="https://bafs.da.gov.ph/index.php/approved-philippine-national-standards/" 
          target="_blank" 
          rel="noopener noreferrer"
          class="hover:bg-yellow-100 hover:text-gray-700 px-1 rounded transition-colors"
        >
          View approved PNS Maximum Residue Limits
        </a>
      </div>
